            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              {lesson.materials.map((material, index) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 text-sm text-slate-700 transition hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700"
                >
